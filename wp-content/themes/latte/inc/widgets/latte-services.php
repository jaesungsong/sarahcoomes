...
class latte_services_widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			//original array( 'description' => __( 'Services widget for Latte theme\'s Services section.', 'latte' ), )
			array( 'description' => __( 'Shows widget for Latte theme\'s Show section.', 'latte' ), )
		);
	}
