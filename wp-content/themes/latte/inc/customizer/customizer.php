...
function latte_customize_register($wp_customize) {
	...
	$wp_customize->add_panel( 'latte_services_settings', array(
		'priority'	   => 30,
		'capability'	 => 'edit_theme_options',
		//original 'title'		  => __('Services Section', 'latte'),
		//original 'description'	=> __('This section allows you to configure Services section.', 'latte')
		'title'		  => __('Show Section', 'latte'),
		'description'	=> __('This section allows you to configure Show section.', 'latte')
	));
	...
	$wp_customize->add_control( 'latte_services_display',array(
		'type' => 'checkbox',
		//original 'label' => __('Disable Services Section','latte'),
		'label' => __('Disable Show Section','latte'),
